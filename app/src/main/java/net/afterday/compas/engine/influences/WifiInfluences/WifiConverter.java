...
public class WifiConverter
{
    ...
    public static double convert(int type, int signal)
    {
        switch (type)
        {
            ...
            case Influence.SPRINGBOARD: return ano(signal);
            case Influence.FUNNEL: return ano(signal);
            case Influence.CAROUSEL: return ano(signal);
            case Influence.ELEVATOR: return ano(signal);
            case Influence.FRYING: return ano(signal);
            case Influence.ELECTRA: return ano(signal);
            case Influence.MEATGRINDER: return ano(signal);
            case Influence.KISSEL: return ano(signal);
            case Influence.SODA: return ano(signal);
            case Influence.ACIDFOG: return ano(signal);
            case Influence.BURNINGFLUFF: return ano(signal);
            case Influence.RUSTYHAIR: return ano(signal);
            case Influence.SPATIALBUBBLE: return ano(signal);
