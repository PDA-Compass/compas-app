...
//MEDICINE (Лечащие)
        ...
        possibleItems.put("Slyudadw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_mica)) //Слюда
...
//ANOMALY (Противоаномальные)
        possibleItems.put("Pruzhinadw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_spring)) //Пружина
        ...
        possibleItems.put("Lunnyysvetdw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_moonlight)) //Лунный свет
...
//PSY (Противоментальные)
        possibleItems.put("Kamennyytsvetokdw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_stone_flower)) //Каменный цветок
        ...
        possibleItems.put("Plyonkadw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_pellicle)) //Плёнка
        ...
        possibleItems.put("Nochnayazvezdadw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_night_star)) //Ночная звезда
        ...
        possibleItems.put("Kompasdw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_compass)) //Компас
...
//NEGATIVE RADIATION (Радиоактивные)
        possibleItems.put("Pustyshkadw345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_shell)) //Пустышка
                .setImage(R.drawable.item_shell)
                .setArtefact(true)
                .addModifier(Item.RADIATION_EMMITER, 1d)
                .setDescription(R.string.desc_shell)
        );
        possibleItems.put("AlteredInsulator345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_altered_insulator)) //Радиоактивный (изменённый) изолятор
        ...
        possibleItems.put("BlackEnergy345", (new ItemDescriptorImpl(ARTIFACTS, R.string.item_black_energy)) //Чёрная (тёмная) энергия
...
//UPGRADES (Обвес)
        possibleItems.put("Binokldw345", (new ItemDescriptorImpl(UPGRADES, R.string.item_binocl)) //Бинокль
        ...
        possibleItems.put("Opticheskiypritseldw345", (new ItemDescriptorImpl(UPGRADES, R.string.item_optics)) //Оптический прицел
        ...
        possibleItems.put("Kollimatordw345", (new ItemDescriptorImpl(UPGRADES, R.string.item_collimator)) //Коллиматор
        ...
        possibleItems.put("NightVision345", (new ItemDescriptorImpl(UPGRADES, R.string.item_night_vision)) //Прибор ночного видения
        ...
        possibleItems.put("Ratsiyadw345", (new ItemDescriptorImpl(UPGRADES, R.string.item_walkie_talkie)) //Рация
        ...
        possibleItems.put("Granatomyotdw345", (new ItemDescriptorImpl(UPGRADES, R.string.item_grenade_launcher)) //Гранатомёт
...
//FOOD (Еда)
        possibleItems.put("Dokhlayakrysadw345", (new ItemDescriptorImpl(FOOD, R.string.item_dead_rat)) //Дохлая крыса
        ...
        possibleItems.put("Batondw345", (new ItemDescriptorImpl(FOOD, R.string.item_bread)) //Батон
        ...
        possibleItems.put("Kolbasadw345", (new ItemDescriptorImpl(FOOD, R.string.item_sausage)) //Колбаса
        ...
        possibleItems.put("Konservadw345", (new ItemDescriptorImpl(FOOD, R.string.item_canned_meat)) //Консерва
        ...
        possibleItems.put("Doktorskayadw345", (new ItemDescriptorImpl(FOOD, R.string.item_doktorskaja)) //Докторская
        ...
        possibleItems.put("Delikatesdw345", (new ItemDescriptorImpl(FOOD, R.string.item_delikates)) //Деликатес
        ...
        possibleItems.put("Gerkulesdw345", (new ItemDescriptorImpl(FOOD, R.string.item_hercules)) //Геркулес
        ...
        possibleItems.put("EnergetikStalkerdw345", (new ItemDescriptorImpl(FOOD, R.string.item_energy_drink)) //Энергетик Сталкер
        ...
        possibleItems.put("Levyyenergetikdw345", (new ItemDescriptorImpl(FOOD, R.string.item_red_devil)) //Левый энергетик
...
//WEAPONS (Оружие)
        possibleItems.put("Nozhdw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_knife)) //Нож
        ...
        possibleItems.put("Pistoletdw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_pistol)) //Пистолет
        ...
        possibleItems.put("Drobovikdw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_shotgun)) //Дробовик
        ...
        possibleItems.put("Pistolet-pulemyotdw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_submachinegun)) //Пистолет-пулемёт
        ...
        possibleItems.put("Kalashdw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_ak)) //Калаш
        ...
        possibleItems.put("M4dw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_m4)) //М4
        ...
        possibleItems.put("Valdw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_val)) //Вал
        ...
        possibleItems.put("Snayperskayavintovkadw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_sniper)) //Снайперская винтовка
        ...
        possibleItems.put("Pulemyotdw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_machinegun)) //Пулемёт
        ...
        possibleItems.put("Gausspushkadw345", (new ItemDescriptorImpl(WEAPONS, R.string.item_gauss_gun)) //Гаусс пушка
...
//AMMO (Боеприпасы)
        possibleItems.put("Pistoletnye9mmdw345", (new ItemDescriptorImpl(AMMO, R.string.item_9mm)) //Пистолетные 9мм
                .setImage(R.drawable.item_9mm)
                .setXpPoints(1)
                .setDescription(R.string.desc_9mm)
        );
        possibleItems.put("Kartech12kalibrdw345", (new ItemDescriptorImpl(AMMO, R.string.item_12cal)) //Картечь 12 калибр
                .setImage(R.drawable.item_12cal)
                .setXpPoints(1)
                .setDescription(R.string.desc_12cal)
        );
        possibleItems.put("OtAK5.45dw345", (new ItemDescriptorImpl(AMMO, R.string.item_545ak)) //От АК 5.45
                .setImage(R.drawable.item_545ak)
                .setXpPoints(1)
                .setDescription(R.string.desc_545ak)
        );
        possibleItems.put("OtNATO5.56dw345", (new ItemDescriptorImpl(AMMO, R.string.item_556nato)) //От НАТО 5.56
                .setImage(R.drawable.item_556nato)
                .setXpPoints(1)
                .setDescription(R.string.desc_556nato)
        );
        possibleItems.put("9mmValdw345", (new ItemDescriptorImpl(AMMO, R.string.item_9val)) //9мм Вал
                .setImage(R.drawable.item_9val)
                .setXpPoints(1)
                .setDescription(R.string.desc_9val)
        );
        possibleItems.put("7.62universalnyedw345", (new ItemDescriptorImpl(AMMO, R.string.item_762)) //7.62 универсальные
                .setImage(R.drawable.item_762)
                .setXpPoints(1)
                .setDescription(R.string.desc_762)
        );
        possibleItems.put("Gausspatronydw345", (new ItemDescriptorImpl(AMMO, R.string.item_atom)) //Гаусс патроны
                .setImage(R.drawable.item_atom)
                .setXpPoints(10)
                .addModifier(Item.RADIATION_INSTANT, 3d)
                .setDescription(R.string.desc_atom)
        );
        possibleItems.put("Bolshoyboekomplektdw345", (new ItemDescriptorImpl(AMMO, R.string.item_bigbk)) //Большой боекомплект
                .setImage(R.drawable.item_bigbk)
                .setXpPoints(20)
                .setDescription(R.string.desc_bigbk)
        );
        possibleItems.put("F1dw345", (new ItemDescriptorImpl(AMMO, R.string.item_f1)) //Ф1
                .setImage(R.drawable.item_f1)
                .setXpPoints(2)
                .setDescription(R.string.desc_f1)
        );
        possibleItems.put("Limonkadw345", (new ItemDescriptorImpl(AMMO, R.string.item_limonka)) //Лимонка
                .setImage(R.drawable.item_limonka)
                .setXpPoints(2)
                .setDescription(R.string.desc_limonka)
        );
        possibleItems.put("Zazhigatelnayagranatadw345", (new ItemDescriptorImpl(AMMO, R.string.item_incend)) //Зажигательная граната
                .setImage(R.drawable.item_incend)
                .setXpPoints(2)
                .setDescription(R.string.desc_incend)
        );
        possibleItems.put("Vystrelkgranatomyotudw345", (new ItemDescriptorImpl(AMMO, R.string.item_podgren)) //Выстрел к гранатомёту
...
//HABAR (Хабар)
        possibleItems.put("Gubnayagarmoshkadw345", (new ItemDescriptorImpl(HABAR, R.string.item_garmoshka)) //Губная гармошка
        ...
        possibleItems.put("Spalnyymeshokdw345", (new ItemDescriptorImpl(HABAR, R.string.item_bag)) //Спальный мешок
        ...
        possibleItems.put("Kanistrabenzinadw345", (new ItemDescriptorImpl(HABAR, R.string.item_gasoline)) //Канистра бензина
        ...
        possibleItems.put("Starayakartadw345", (new ItemDescriptorImpl(HABAR, R.string.item_maps)) //Старая карта
        ...
        possibleItems.put("Potryopannayagitaradw345", (new ItemDescriptorImpl(HABAR, R.string.item_guitar)) //Потрёпанная гитара
        ...
        possibleItems.put("Yashchiksinstrumentamidw345", (new ItemDescriptorImpl(HABAR, R.string.item_instruments)) //Ящик с инструментами
        ...
        possibleItems.put("Neponyatnyypribordw345", (new ItemDescriptorImpl(HABAR, R.string.item_psionic_device)) //Непонятный прибор
        ...
        possibleItems.put("PDAsvazhnoyinfoydw345", (new ItemDescriptorImpl(HABAR, R.string.item_pda)) //ПДА с важной инфой
        ...
        possibleItems.put("-10%kugrozamdw345", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_10)) //-10% к некоторым угрозам
        ...
        possibleItems.put("-25%kugrozamdw345", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_25)) //-25% к некоторым угрозам
        ...
        possibleItems.put("-50%kugrozamdw345", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_50)) //-50% к некоторым угрозам
        ...
        possibleItems.put("-75%kugrozamdw345", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_75)) //-99,9% к некоторым угрозам
